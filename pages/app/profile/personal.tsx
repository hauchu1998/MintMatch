  ...
  return (
    <div className="mt-5 w-full">
      ...
      <div className="mt-2 w-full grid grid-cols-2 gap-3">
        {data?.profile &&
          data.profile.nfts.map((nft: any, index: number) => (
      ...
      <div className="mt-5 w-full">
        ...
        <div className="text-lg">{data?.profile.username}</div>
      </div>
      <div className="mt-3 w-full ">
        <div className="w-full py-1 border-b border-[#195573] text-[#195573] text-xl">
          Introduction
        </div>
        <div className="text-lg">{data?.profile.introduction}</div>
      </div>
      <div className="mt-3 w-full ">
        <div className="w-full py-1 border-b border-[#195573] text-[#195573] text-xl">
          Label
        ...
        <div className="mt-3 grid grid-cols-4 gap-3 px-2">
          {data?.profile.labels.map((label: any) => (
            <div
              key={label}
